...
M.setup = function()
  ...
  local groups = {
    ...
    DiagnosticVirtualTextError = { link = "lspError" },
    DiagnosticVirtualTextWarn = { link = "lspWarn" },
    DiagnosticVirtualTextInfo = { link = "lspInfo" },
    DiagnosticVirtualTextHint = { link = "lspHint" },
