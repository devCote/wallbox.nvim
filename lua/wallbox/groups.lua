...
M.setup = function()
  ...
  local groups = {
    ...
    DiagnosticSignError = { link = { fg = "#9d0006" } },
    DiagnosticUnderlineError = { link = { fg = "#9d0006" } },
    DiagnosticWarn = { link = { fg = "#fabd2f" } },
    DiagnosticSignWarn = { link = { fg = "#fabd2f" } },
    DiagnosticUnderlineWarn = { link = { fg = "#fabd2f" } },
    DiagnosticInfo = { link = { fg = "#076678" } },
    DiagnosticSignInfo = { link = { fg = "#076678" } },
    DiagnosticUnderlineInfo = { link = { fg = "#076678" } },
    DiagnosticHint = { link = { fg = "#2ba2b3" } },
    DiagnosticSignHint = { link = { fg = "#2ba2b3" } },
    DiagnosticUnderlineHint = { link = { fg = "#2ba2b3" } },
    DiagnosticFloatingError = { link = { fg = "#cc241d" } },
    DiagnosticFloatingWarn = { link = { fg = "#fe8019" } },
    DiagnosticFloatingInfo = { link = { fg = "#458588" } },
    DiagnosticFloatingHint = { link = { fg = "#2ba2b3" } },
    DiagnosticVirtualTextError = { link = { fg = "#cc241d" } },
    DiagnosticVirtualTextWarn = { link = { fg = "#fabd2f" } },
    DiagnosticVirtualTextInfo = { link = { fg = "#076678" } },
    DiagnosticVirtualTextHint = { link = { fg = "#2ba2b3" } },
