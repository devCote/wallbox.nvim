...
M.setup = function()
  ...
  local groups = {
    ...
    -- LSP Diagnostic
    DiagnosticError = { link = "#9d0006" },
    DiagnosticSignError = { link = "#9d0006" },
    DiagnosticUnderlineError = { link = "#9d0006" },
    DiagnosticWarn = { link = "#fabd2f" },
    DiagnosticSignWarn = { link = "#fabd2f" },
    DiagnosticUnderlineWarn = { link = "#fabd2f" },
    DiagnosticInfo = { link = "#076678" },
    DiagnosticSignInfo = { link = "#076678" },
    DiagnosticUnderlineInfo = { link = "#076678" },
    DiagnosticHint = { link = "#2ba2b3" },
    DiagnosticSignHint = { link = "#2ba2b3" },
    DiagnosticUnderlineHint = { link = "#2ba2b3" },
    DiagnosticFloatingError = { link = "#cc241d" },
    DiagnosticFloatingWarn = { link = "#fe8019" },
    DiagnosticFloatingInfo = { link = "#458588" },
    DiagnosticFloatingHint = { link = "#2ba2b3" },
    DiagnosticVirtualTextError = { link = "#cc241d" },
    DiagnosticVirtualTextWarn = { link = "#fabd2f" },
    DiagnosticVirtualTextInfo = { link = "#076678" },
    DiagnosticVirtualTextHint = { link = "#2ba2b3" },
